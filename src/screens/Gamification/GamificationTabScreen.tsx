...
const styles = StyleSheet.create({
    ...
    centered: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20, paddimBottom: 100 },
    ...
    section: { marginHorizontal: 16, marginTop: 24, paddingBottom: 12 },
    sectionTitle: { fontSize: 18, fontWeight: 'bold', marginBottom: 12 },
    noDataText: { textAlign: 'center', color: '#6B7280', fontStyle: 'italic', paddingVertical: 20 },
    userCoinsContainer: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 16, paddingVertical: 8, backgroundColor: '#FFFBEB', borderRadius: 12, borderColor: '#FEF3C7', borderWidth: 1 },
    ...
    purchaseButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', margin: 12, paddingVertical: 12, borderRadius: 12, gap: 8 },

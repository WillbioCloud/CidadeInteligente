...
import {
  ...
  Alert,
  TouchableOpacity,
  Image, // Usamos Image para as logos
  Text,
  RefreshControl
} from 'react-native';
...
// Libs e Dados
import { supabase } from '../../lib/supabase';
import { Loteamento } from '../../data/loteamentos.data';
...
const loteamentoLogos = {
  ...
  'LOGO-PARQUE-FLAMBOYANT.webp': require('../../assets/logos/LOGO-PARQUE-FLAMBOYANT.webp'), // Corrigido para o nome do seu arquivo
};

// Tipagem para os dados que vêm do Supabase
interface LoteamentoData extends Loteamento {
  ...
  return (
    <View style={styles.loteamentoCard}>
      <View style={styles.cardImageContainer}>
        <Image
          source={loteamentoLogos[item.logo] || { uri: item.image_url }}
